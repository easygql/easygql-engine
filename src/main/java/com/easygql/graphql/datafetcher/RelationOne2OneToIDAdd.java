...
public class RelationOne2OneToIDAdd implements  EasyGQLDataFetcher<Object> {
    ...
    public RelationOne2OneToIDAdd(RelationField relationField, String schemaID, SchemaData schemaData) {
    ...
    public Object get(DataFetchingEnvironment dataFetchingEnvironment) throws Exception {
        ...
        CompletableFuture.runAsync(()->{
            try {
                ...
                one2OneRelationCreater.toAdd(toID,fromID).whenComplete((result,resultEx)->{
                    if(null!=resultEx) {
