...
public class RelationMany2ManyFromRemover implements  EasyGQLDataFetcher<Object> {
    ...
    public RelationMany2ManyFromRemover(RelationField relationField, String schemaID, SchemaData schemaData) {
    ...
    public Object get(DataFetchingEnvironment dataFetchingEnvironment) throws Exception {
        ...
        CompletableFuture.runAsync(()->{
            try {
                ...
                List<String> toID = dataFetchingEnvironment.getArgument(GRAPHQL_TO_ID);
                this.Many2ManyRelationRemover.fromRemove(fromID,toID).whenComplete((result,resultEx)->{
                    if(null!=resultEx) {
