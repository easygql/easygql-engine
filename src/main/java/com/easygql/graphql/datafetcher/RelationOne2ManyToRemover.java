...
public class RelationOne2ManyToRemover implements  EasyGQLDataFetcher<Object> {
    ...
    public RelationOne2ManyToRemover(RelationField relationField, String schemaID, SchemaData schemaData) {
    ...
    public Object get(DataFetchingEnvironment dataFetchingEnvironment) throws Exception {
        ...
        CompletableFuture.runAsync(()->{
            try {
                ...
                one2ManyRemover.toRemove(toID).whenComplete((result,resultEx)->{
                    if(null!=resultEx){
